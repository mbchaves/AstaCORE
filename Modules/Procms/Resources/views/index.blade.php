            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ProCMS :: {{ $appTilte }}</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/procms">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ $appTilte }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                ...
                                <h6 class="text-white">ProCMS : {{ $appTilte }}</h6>
                            </div>
                        <div class="card card-hover">
